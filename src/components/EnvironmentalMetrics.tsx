...
export function EnvironmentalMetrics() {
  return (
    <div className="rounded-xl overflow-hidden backdrop-blur-xl bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
      <div className="p-8 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-4xl font-bold tracking-tight bg-gradient-to-br from-emerald-300 via-teal-200 to-cyan-300 bg-clip-text text-transparent">
          ...
          <div className="text-sm text-white/80 bg-white/5 px-6 py-3 rounded-full border border-white/10 shadow-lg backdrop-blur-md">
            Last updated: {new Date().toLocaleTimeString()}
          </div>
        </div>
        
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <Card className="group hover:scale-105 transition-all duration-500 ease-out bg-gradient-to-br from-green-500/10 to-transparent border-green-500/20 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-white/90">Soil Moisture</CardTitle>
              <div className="p-2.5 bg-green-500/20 rounded-full group-hover:bg-green-500/30 transition-all duration-500 group-hover:scale-110 shadow-lg">
            ...
            <CardContent>
              <div className="flex items-baseline gap-1">
                ...
                <div className="text-lg text-green-400/80">%</div>
              </div>
              <div className="flex items-center gap-2 mt-3">
                <div className="h-2 w-2 rounded-full bg-green-400 animate-pulse shadow-[0_0_12px_rgba(74,222,128,0.6)]"></div>
                <p className="text-xs text-white/70 font-medium">Optimal Range: 40-60%</p>
              </div>
              <div className="flex items-center gap-3 mt-4">
                <span className="text-[10px] px-2.5 py-1 rounded-full bg-yellow-500/20 text-yellow-400 border border-yellow-500/20 font-medium">
                  3 alerts
                </span>
